...
def main():
    ...
    parser.add_argument("--activation", type=str, default="relu")  # add activation cjoice to the args 2018-1-1
    ...
    activation_choice = args.activation  # add activation cjoice to the args 2018-1-1
    ...
    print("ACTIVATION", activation_choice)
    print("=====================\n")
    ...
    if activation_choice == "sigmoid":                                                 #Insert activation choice
        encoder_activations = ["sigmoid", "sigmoid", "sigmoid", "sigmoid", "sigmoid", "softmax"]    #Insert activation choice
    elif activation_choice == "relu":                                                #Insert activation choice  
        encoder_activations = ["relu", "relu", "relu", "relu", "relu", "softmax"]    #Insert activation choice
    else:                                                                            #Insert activation choice
        encoder_activations = ["relu", "relu", "relu", "relu", "relu", "softmax"]    #Insert activation choice
